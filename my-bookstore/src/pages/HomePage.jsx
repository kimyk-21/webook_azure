...
const BASE_URL = "https://20-93-32-30.nip.io/api/books"; // 백엔드 API 주소
const RATING_URL = "https://20-93-32-30.nip.io/ratings/average"; // 평점 평균 API 주소
            ...
            books
              ...
              .map((book, index) => (
                ...
                >
                  {/* 도서 이미지 */}
                  <img 
                    src={`https://20-93-32-30.nip.io${book.imageUrl}`} 
                    alt={book.title} 
